...
namespace CaoGiaConstruction.WebClient.Areas.Admin.Controllers.ViewComponents
{
    public class vcPagingAdmin : ViewComponent
    {
        private readonly IHttpContextAccessor _httpContextAccessor;

        public vcPagingAdmin(IHttpContextAccessor httpContextAccessor)
        {
