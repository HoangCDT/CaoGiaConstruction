namespace CaoGiaConstruction.WebClient.Const
{
    ...
    {
        public static readonly string HOME_SLIDE_TOP = "HOME_SLIDE_TOP";
        public static readonly string HOME_SLIDE_ACHIEVEMENT = "HOME_SLIDE_ACHIEVEMENT";
        public static readonly string HOME_SLIDE_GALLERY = "HOME_SLIDE_GALLERY";
