...
namespace CaoGiaConstruction.Utilities
{
    public static class ConvertUltility
    {
        ...
        /// <returns></returns>
        public static string ToString(this object value, string tempFormat, bool isDotCurrency = false)
        {
            if (value == null)
            {
                return string.Empty;
            }
            string result = string.Format("{0:" + tempFormat + "}", value);
            return isDotCurrency ? result.Replace(",", ".") : result;
        }

        public static string ToTextDefault(this object value, string textDefault = "Chưa cập nhật")
        {
        ...
        public static object GetPropByName(this object src, string propName)
        {
            return src.GetType().GetProperty(propName).GetValue(src, null);
        }

        public static string ToCurrency(this object value, string tempFormat)
        {
            if (value == null)
            {
                return string.Empty;
