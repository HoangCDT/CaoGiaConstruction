...
namespace CaoGiaConstruction.Utilities
{
    public static class SecurityUtility
    {
        ...
        public static string GetSHA512(string text)
        {
            ...
            using (System.Security.Cryptography.SHA512 hashString = System.Security.Cryptography.SHA512.Create())
            {
                string hex = "";
        ...
        public static string Encrypt(this string text, string salt = "ABC2021")
        {
        ...
        public static string Decrypt(this string cipherText, string salt = "ABC2021")
        {
